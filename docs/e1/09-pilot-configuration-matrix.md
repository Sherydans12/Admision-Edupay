...
Esta matriz separa el valor inicial confirmado para Colegio Conquistadores 2027 de los parámetros que deben continuar configurables en el núcleo. `DEFINED_FOR_PILOT` indica detalle operativo definido para el piloto; no autoriza implementación ni cierra E1-B o G1.
...
| Promoción de espera | Oferta/lista de espera | Nunca automática; acción de Responsable de Admisión o Administrador Máximo | Sí | Responsable de Admisión; Administrador Institucional Máximo; Dirección sólo si recibe capacidad | Selección, motivo, actor, reserva y oferta | Oferta y origen lista de espera | Criterios operativos de promoción |
